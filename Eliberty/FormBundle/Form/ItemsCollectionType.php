...
use Eliberty\RedpillBundle\Form\EventListener\ResizeOrderitemsFormListener;
...
class ItemsCollectionType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $resizeListener = new ResizeOrderitemsFormListener(
            $prototypes,
            $options['options'],
            $options['allow_add'],
    ...
    {
        $options['options']['recursion_level'] = $options['recursion_level'];
